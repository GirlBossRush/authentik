...
#### Less-frequent validation <span className="badge badge--version">authentik 2022.5.1+</span>
...
#### Passwordless authentication <span className="badge badge--version">authentik 2021.12.4+</span>
...
#### WebAuthn Device type restrictions <span className="badge badge--version">authentik 2024.4+</span>
