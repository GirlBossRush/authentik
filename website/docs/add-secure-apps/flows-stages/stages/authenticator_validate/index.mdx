...
#### Less-frequent validation&nbsp;<VersionBadge semver="2022.5.1" />
...
#### Passwordless authentication&nbsp;<VersionBadge semver="2021.12.4" />
...
#### WebAuthn Device type restrictions&nbsp;<VersionBadge semver="2024.4" />
