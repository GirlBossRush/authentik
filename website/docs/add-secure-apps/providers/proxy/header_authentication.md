...
### Receiving HTTP Basic authentication <span className="badge badge--version">authentik 2023.1+</span>
...
### Receiving HTTP Bearer authentication <span className="badge badge--version">authentik 2023.1+</span>
