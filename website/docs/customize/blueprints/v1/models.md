...
### `key` <span className="badge badge--version">authentik 2023.4+</span>
...
### `password` <span className="badge badge--version">authentik 2023.6+</span>
...
### `permissions` <span className="badge badge--version">authentik 2024.8+</span>
...
### `icon` <span className="badge badge--version">authentik 2023.5+</span>
