...
### `ak_call_policy(name: str, **kwargs) -> PolicyResult` <span className="badge badge--version">authentik 2021.12+</span>
...
### `ak_user_has_authenticator(user: User, device_type: Optional[str] = None) -> bool` <span className="badge badge--version">authentik 2022.9+</span>
...
### `ak_create_event(action: str, **kwargs) -> None` <span className="badge badge--version">authentik 2022.9+</span>
...
### `ak_create_jwt(user: User, provider: OAuth2Provider | str, scopes: list[str], validity = "seconds=60") -> str | None` <span className="badge badge--version">authentik 2025.2+</span>
...
## DNS resolution and reverse DNS lookups <span className="badge badge--version">authentik 2023.3+</span>
