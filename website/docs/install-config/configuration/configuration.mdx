...
### `AUTHENTIK_SESSION_STORAGE`&nbsp;<VersionBadge semver="2024.4" />
...
### `AUTHENTIK_WEB__WORKERS`&nbsp;<VersionBadge semver="2022.9" />
...
## System settings&nbsp;<VersionBadge semver="2024.2" />
