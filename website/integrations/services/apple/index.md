...
You'll need to add your own [custom domain](https://support.apple.com/guide/apple-business-manager/add-and-verify-a-domain-axm48c3280c0/1/web/1) to use _Managed Apple Accounts_ with federated authentication.
