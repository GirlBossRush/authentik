...
- <span className="badge badge--secondary">Support level: Community</span> The
  integration is community maintained.

- <span className="badge badge--info">Support level: Vendor</span> The integration
  is supported by the vendor.

- <span className="badge badge--primary">Support level: authentik</span> The
